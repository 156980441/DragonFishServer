...
<body scroll="no" onload="getLangDate()">
	<div id="layout">
		<div id="header">
			<div class="headerNav">
				<div id="dateStr" class="word_grey" style="color:#FFFFFF; font-size:18px; margin-top:10px"></div>
				<ul class="nav">
				...
				<div class="accordion" fillSpace="sidebar">
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="/login/viewUserList" target="navTab" rel="sys001">用户管理</a></li>
							<li><a href="/business/viewAdvertiseList" target="navTab" rel="sys002">广告管理</a></li>
							<li><a href="/business/viewMachineList" target="navTab" rel="sys003">设备管理</a></li>
							<li><a href="/business/viewStartPageList" target="navTab" rel="sys004">启动页面</a></li>
						</ul>
					</div>
				</div>
			</div>
...
位图广告,链接广告：http://115.29.147.177:8099/interface/getAdvertiseListByCity/city   get
启动页面：http://115.29.147.177:8099/interface/getStartPageListByCity/city get
...
删除设备：http://115.29.147.177:8099/interface/deleteMachineInfo/USER_NO/MACHINE_ID get
设置继电器状态:http://115.29.147.177:8099/interface/setRelaySwitch/MACHINE_ID/status(0,1) get
